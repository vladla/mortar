...
import com.example.mortar.drawer.mortarflow.MortarContextFactory;
...
public class FramePathContainerView extends FrameLayout
  ...
  public FramePathContainerView(Context context, AttributeSet attrs) {
    this(context, attrs, new SimplePathContainer(R.id.screen_switcher_tag, Path.contextFactory(new MortarContextFactory())));
  }
