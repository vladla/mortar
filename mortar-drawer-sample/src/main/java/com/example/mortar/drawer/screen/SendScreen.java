...
import com.example.mortar.drawer.view.SendView;
 ...
 */
@Layout(R.layout.send_view)
@WithModule(SendScreen.Module.class)
public class SendScreen extends Path {

    @dagger.Module(injects = SendView.class, addsTo = RootModule.class)
    public static class Module {
    }

    @Singleton
    public static class Presenter extends ViewPresenter<SendView> {
