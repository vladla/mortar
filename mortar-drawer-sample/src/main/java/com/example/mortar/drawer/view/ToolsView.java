...
public class ToolsView extends LinearLayout {
    @Inject
    ToolsScreen.Presenter presenter;
    ...
    public ToolsView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void showContent() {
        ...
        textView.setText("Tools view has been loaded");
        addView(textView);
    }
